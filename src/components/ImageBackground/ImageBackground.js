...
ImageBackground.propTypes = {
  ...
  * */ 
   ...
   */
  defaultSource: PropTypes.oneOfType([PropTypes.object, PropTypes.array, PropTypes.number]),
   ...
   */
  source: PropTypes.oneOfType([PropTypes.object, PropTypes.array, PropTypes.number, PropTypes.string]),
   ...
   */
  loadingIndicatorSource: PropTypes.oneOfType([PropTypes.object, PropTypes.array, PropTypes.number]),
